        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-6">
              Connecting top talent with leading companies through AI-powered resume matching.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-sm text-gray-400">support@talentmatch.com</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                <FontAwesomeIcon icon="map-marker-alt" className="text-primary-500 mt-1 mr-3" />
