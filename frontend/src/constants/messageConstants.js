...
export const RESUME_MESSAGES_REQUEST = 'RESUME_MESSAGES_REQUEST';
export const RESUME_MESSAGES_SUCCESS = 'RESUME_MESSAGES_SUCCESS';
export const RESUME_MESSAGES_FAIL = 'RESUME_MESSAGES_FAIL';