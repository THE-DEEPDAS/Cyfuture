...
const JobSearch = () => {
  ...
  const [jobs, setJobs] = useState([
    ...
    },
    {
      ...
      description: 'Looking for a talented Full Stack Developer to help us grow...',
    ...
    },
    {
      ...
      description: 'We need a creative designer to help us create amazing user experiences...',
        ...
        <div className="space-y-4">
          ...
          {filteredJobs.length === 0 && (
            <div className="bg-background-secondary rounded-lg p-8 text-center">
              <FontAwesomeIcon icon="search" className="text-3xl text-gray-500 mb-2" />
      ...
      <div className="lg:w-1/3">
        {selectedJob ? (
            ...
            {isApplying ? (
              <div className="fade-in">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-semibold text-white">Apply for Job</h2>
                  <button 
              ...
              <div className="fade-in">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="flex items-center">
                    <FontAwesomeIcon icon="money-bill-wave" className="text-primary-500 mr-2" />
                    <span className="text-gray-300">{selectedJob.salary}</span>
                  </div>
                  
                  <div className="flex items-center">
                    <FontAwesomeIcon icon="user-tie" className="text-primary-500 mr-2" />
                    <span className="text-gray-300">{selectedJob.experience}</span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-primary-600 hover:bg-primary-700 rounded-md text-white font-medium transition-colors"
                  >
                    Apply Now
                  </button>
                </div>
          ...
          <div className="card text-center py-12">
            <FontAwesomeIcon icon="file-alt" className="text-5xl text-gray-600 mb-4" />
            <h3 className="text-lg font-medium text-white">No Job Selected</h3>
            <p className="text-gray-400 mt-2">Select a job from the list to view details</p>
          </div>
        )}
      </div>
    </div>
