/**
 * Simple test for the improved resume extractor
 */
import fs from "fs";
import path from "path";
import { extractResumeDataWithLLM } from "./services/improvedResumeExtractor.js";

// Test the improved extractor with a real resume
async function testImprovedExtractor() {
  try {
    ...
    console.error("Error testing improved extractor:", error);
    throw error;
  }
}

// Run the test
testImprovedExtractor().catch((error) => {
